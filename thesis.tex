...
\ifoot{\footnotesize{Diah Ayu Irawati}}
...
{
	(\textwidth ,0.4pt)
	\footnotesize{Diah Ayu Irawati} \hfill \footnotesize{Master thesis}} 
	{\footnotesize{Diah Ayu Irawati} \hfill \footnotesize{Master thesis}} 
	{\footnotesize{Diah Ayu Irawati} \hfill \footnotesize{Master thesis}}
	(0pt ,0pt)
}
...
\begin{document}
	...
	%Erklärung
        \thispagestyle{myPageStyle} % Custom page style for affidavit
        \include{Affidavit} 
...
%--------------------------------------------------------------------------------
	...
	%\printglossary[title=Glossary, toctitle=Glossary]
        \include{glossary}
       %\addcontentsline{toc}{section}{Glossary} %\printglossary[title=Abkürzungsverzeichnis,toctitle=Abkürzungsverzeichnis] 	% Rename for German thesis
